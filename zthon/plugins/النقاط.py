...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗘𝗹𝗹𝗼𝗿𝘆 - أوامـر تجميـع النقـاط](t.me/SOURCE_ELLORY) 𓆪\n\n"
    "**𓆰 قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس اللـوري🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "**𓆰 قـائمـة أوامـر تجميـع نقـاط العـاب بـوت وعـد🦾 :** \n\n"
    "`.بخشيش وعد`\n"
    "`.راتب وعد`\n"
    "`.استثمار وعد`\n"
    "`.كلمات وعد`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @S_4_N**"
)
