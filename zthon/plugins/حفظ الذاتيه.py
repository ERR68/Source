...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗘𝗹𝗹𝗼𝗿𝘆 - حفـظ الذاتـيـة ♥️](t.me/SOURCE_ELLORY) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    "**لـ تفعيـل الحفظ التلقائي للذاتيـه**\n"
    "**سوف يقوم حسابك بحفظ الذاتيه تـلقـائيـًا في حافظة حسابك عندما يرسل لك اي شخص ميديـا ذاتيـه**\n\n\n"
    "**⪼** `.تعطيل الذاتيه`\n"
    "**لـ تعطيـل الحفظ التلقائي للذاتيـه**\n\n\n"
    "**⪼** `.ذاتيه`\n"
    "**بالـرد ؏ــلى صـوره ذاتيـه لحفظهـا في حال كان امر الحفظ التلقائي معطـل**\n\n"
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗘𝗹𝗹𝗼𝗿𝘆 ](t.me/SOURCE_ELLORY) 𓆪"
)
