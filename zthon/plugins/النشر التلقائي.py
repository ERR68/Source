...
""" الوصـف : تحـديث أوامـر النشـر التلقـائـي للقنـوات ™
الأوامـر صـارت تدعـم المعـرفـات والروابـط الى جانب ايديـات القنـوات
حقـوق : @ZedThon
...
ZelzalNSH_cmd = (
    "𓆩 [ 𝗘𝗹𝗹𝗼𝗿𝘆 - أوامـر النشـر التلقـائي](t.me/SOURCE_ELLORY) 𓆪\n\n"
    ...
    "**- استخـدم الامـر بقنـاتـك \n\n\n"
    "**- ملاحظـه :**\n"
    "**- الأوامـر صـارت تدعـم المعـرفات والروابـط الى جـانب الايـدي 🏂🎗**\n"
