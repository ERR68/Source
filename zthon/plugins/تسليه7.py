...
async def _(event):
    zel_dev = (5116968555, 647484849, 778538585, 1267475030, 1260465030, 126765030, 1260475030, 1260476030)
    if event.reply_to_msg_id:
        ...
        if idd == 925972505 or idd == 5116968555 or idd == 528039206 or idd == 134652270:
            ...
            animation_chars = [
                "**⌔: جاري الاتصال بخوادم تيبثون المتخصصه بالـتهكير**",
