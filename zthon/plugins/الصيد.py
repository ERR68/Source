...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗘𝗹𝗹𝗼𝗿𝘆 - أوامـر الصيد والتشيكـر](t.me/SOURCE_ELLORY) 𓆪\n\n"
    ...
    "**- انضـم للقنـاة ~ @TASHKER_ELLORY**\n"

    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن اللـوري**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗘𝗹𝗹𝗼𝗿𝘆 - أنـواع اليـوزرات](t.me/SOURCE_ELLORY) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد اللـوري 𝗘𝗹𝗹𝗼𝗿𝘆 ⎉",

                    about="This channel to hunt username by - @SOURCE_ELLORY ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت اللـوري 𝗘𝗹𝗹𝗼𝗿𝘆 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس اللـوري - @SOURCE_ELLORY ",
