...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت اللـوري"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗘𝗟𝗟𝗢𝗥𝗬 ─┄─┄─┄─⋆"
zed_dev = (5116968555, 463636842)
zel_dev = (5116968555, 52581064)
zelzal = (5116968555, 1264384082)
