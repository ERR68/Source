    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/d96599116bdfb21bf1509.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس اللـوري الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗘𝗟𝗟𝗢𝗥𝗬", "https://t.me/SOURCE_ELLORY"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "Ellory")
...
zthon = {"@SOURCE_ELLORY", "@ELLORY_SUPPORT", "@SUPER_ELLORY"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Ellor.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل اللـوري", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Ellory.jpg")
